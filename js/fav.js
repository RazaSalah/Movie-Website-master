...
let favlist = JSON.parse(localStorage.myfav);
console.log(favlist);
if (favlist!=null){
    ...
    for(let i=0; i<favlist.length; i++){
        ...
        axios.get(`https://api.themoviedb.org/3/movie/${favlist[i]}?api_key=bd95210b0fc359499095f827f48634cf`).then(
            (response) => {
  ...
  function removeFromFav(id) {
   favlist= localStorage.getItem("myfav");
    favlist= JSON.parse(favlist);
    const movieID = favlist.indexOf(id); 
    favlist.splice(movieID,  1);
